...
Click somewhere on the canvas and open the Property Panel on the right. Change the [id](/reference/dmn11/drg/#decision-requirements-graph-id) of the DRD to "dinnerDecisions". Next, change the [name](/reference/dmn11/drg/#decision-requirements-graph-name) of the DRD to "Dinner Decisions".
...
Next, connect the *Dish* decision to the *Beverages* decision to indicate that the *Dish* decision is a [required decision](/reference/dmn11/drg/#required-decisions) of the *Beverages* decision. That means that it is used as an input for the decision and the output value "desiredDish" can be accessed there.
...
* learn more about [DMN in Cockpit](/manual/webapps/cockpit/dmn) and specialized views for DRGs (Enterprise Feature)
